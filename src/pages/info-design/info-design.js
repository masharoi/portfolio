      ...
      <div className="info-container">
        <div className="info-text">
          ...
          <p>
            ...
            rates varied across different regions and states. Moreover, I
            explored how financial factors and advertising efforts affected the
      ...
      <div className="info-container">
        <div className="info-text">
          ...
          <p>
            ...
            thorough research of the history of voting rights. As a result, I
            compiled a{" "}
            <a target="_blank" href={conceptMap} className="info-link">
              concept map
            </a>
            , which helped me to get a better understanding of the context of
            the voting and election laws that have been passed throughout the
            last two hundred years in the United States. The goal for this
            project was to show how different groups of the population gained
            more voting rights over the years and what events and social
            movements contributed to that change.
            <br />
